namespace dotnet
{
  partial class AIChatVisualisation
  {
    /// <summary>
    ...
    private void InitializeComponent()
    {
      ...
      analyticsControl.Size = new Size(1356, 845);
      analyticsControl.Subject = null;
      analyticsControl.TabIndex = 0;
      analyticsControl.Tenant = null;
      analyticsControl.VisReadOnly = false;
      analyticsControl.Load += AIChatVisualisation_Load;
      // 
      // AIChatVisualisation
      // 
      AutoScaleDimensions = new SizeF(7F, 15F);
      AutoScaleMode = AutoScaleMode.Font;
      ClientSize = new Size(1356, 845);
      Controls.Add(analyticsControl);
      Name = "AIChatVisualisation";
      Text = "AIChatVisualisation";
      ResumeLayout(false);
    }
